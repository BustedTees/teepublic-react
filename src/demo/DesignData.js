const design = {
  ...
  _embedded: {
    ...
    defaultProduct: {
      ...
      _links: {
        self: {
          href: 'https://api.teepublic.com/v1/designs/1983186/products/t-shirt'
        }
      }
    },
    tags: ['homer-simpson', 'trampoline', 'homer', 'simpsons', 'tramampoline'],
    relatedTags: [
      'homer',
      'bart',
      'simpson',
    ...
    products: [
      ...
      },
      {
        ...
        _links: {
          self: {
            href: 'https://api.teepublic.com/v1/designs/1983186/products/hoodie'
          }
        }
      },
      {
      ...
      },
      {
        ...
        _links: {
          self: {
            href: 'https://api.teepublic.com/v1/designs/1983186/products/onesie'
          }
        }
      },
      {
  ...
  _links: {
    ...
    products: [
      ...
      {
        href: 'https://api.teepublic.com/v1/designs/1983186/products/tank-top'
      },
      {
        href:
          'https://api.teepublic.com/v1/designs/1983186/products/kids-t-shirt'
      ...
      {
        href: 'https://api.teepublic.com/v1/designs/1983186/products/phone-case'
      },
      {
        href: 'https://api.teepublic.com/v1/designs/1983186/products/notebook'
      },
      {
        href:
          'https://api.teepublic.com/v1/designs/1983186/products/laptop-case'
      ...
      {
        href: 'https://api.teepublic.com/v1/designs/1983186/products/sticker'
      },
      {
        href:
          'https://api.teepublic.com/v1/designs/1983186/products/throw-pillow'
      ...
      {
        href: 'https://api.teepublic.com/v1/designs/1983186/products/tapestry'
      }
    ]
  }
};
